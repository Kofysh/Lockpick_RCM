...
static const u8 master_kek_sources[KB_FIRMWARE_VERSION_MAX - KB_FIRMWARE_VERSION_620 + 1][0x11] __attribute__((aligned(4))) = {
    ...
    {0x66, 0xC8, 0xCB, 0x3D, 0xEC, 0xF4, 0x59, 0x73, 0x54, 0x88, 0xE1, 0x2E, 0xE6, 0x3D, 0x68, 0x46}, /* 21.0.0 Device Master Kek Source. */
    {0x15, 0xAC, 0x96, 0x34, 0xF5, 0x32, 0x56, 0x68, 0xFE, 0x5B, 0x9D, 0xD7, 0xED, 0x19, 0xB7, 0x8E}, /* 22.0.0 Device Master Kek Source. */

}; //!TODO: Update on mkey changes.

static const u8 master_key_vectors[KB_FIRMWARE_VERSION_MAX + 1][0x11] __attribute__((aligned(4))) = {
...
static const u8 master_key_vectors_dev[KB_FIRMWARE_VERSION_MAX + 1][0x11] __attribute__((aligned(4))) = {
...
static const u8 mariko_key_vectors[][0x11] __attribute__((aligned(4))) = {
    ...
    {0x82, 0xE2, 0x0A, 0x59, 0x67, 0xDF, 0xBF, 0x51, 0x47, 0x62, 0x11, 0xF2, 0x41, 0xD3, 0xEE, 0x13}, /* Zeroes encrypted with AES Class Key 15 */
...
static const u8 mariko_master_kek_sources[KB_FIRMWARE_VERSION_MAX - KB_FIRMWARE_VERSION_600 + 1][0x11] __attribute__((aligned(4))) = {
    ...
    {0x82, 0xE2, 0x0A, 0x59, 0x67, 0xDF, 0xBF, 0x51, 0x47, 0x62, 0x11, 0xF2, 0x41, 0xD3, 0xEE, 0x13}, /* 22.0.0 Device Master Kek Source. */
}; //!TODO: Update on mkey changes.
static const u8 mariko_master_kek_sources_dev[KB_FIRMWARE_VERSION_MAX - KB_FIRMWARE_VERSION_600 + 1][0x11] __attribute__((aligned(4))) = {
