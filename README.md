Kofy_RCM
=
Kofy_RCM is a bare metal Nintendo Switch payload that derives encryption keys for use in Switch file handling software like hactool, hactoolnet/LibHac, ChoiDujour, etc. without booting Horizon OS.
...
* Launch Kofy_RCM.bin using your favorite payload injector or chainloader
